...
class Showpage extends StatelessWidget {
  ...
  Showpage(
      {required this.Name, required this.Email, required this.Phone, required this.Address, required this.DOB, required this.Gender, required this.Qualify, required this.Desig, required this.Experience, required this.Nationality, required this.LKnown});
    ...
    TableRow _tablerow = TableRow(
        children: [
          Padding(padding: EdgeInsets.all(10),
            child: Text('Bio Data', style: TextStyle(fontSize: 25)),
          ),
